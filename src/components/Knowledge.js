import { BadgeCheckIcon, ChipIcon, AcademicCapIcon } from "@heroicons/react/solid";
...
export default function Skills() {
  return (
    <section id="skills">
      <div className="container px-5 py-10 mx-auto  border-b border-gray-500 border-b-[45px]">
