      ...
      <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center border-b border-gray-500 border-b-[45px]">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-white">
            Hi, I'm Nicolas.
            <br className="hidden lg:inline-block" />Dev Full Stack.
          </h1>
          <p className="mb-8 leading-relaxed">
            Software Developer | Software Engineering <br/>
            Mid-Level Full Stack Developer with experience developing web and desktop applications.
          </p>
